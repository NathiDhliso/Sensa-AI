 ...
 */
function extractMindMapFromAST(ast: any): ParsedMindMap {
...
function processMindMapNodes(
  ...
  astNodes.forEach((astNode, index) => {
 ...
 */
function extractLabel(astNode: any): string {
 ...
 */
function determineShapeFromAST(astNode: any, level: number): ParsedNode['shape'] {
