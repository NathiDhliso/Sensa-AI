  ...
  return (
    <div className={`min-h-screen ${pageTheme.background}`}>
      ...
      <motion.header
        ...
        className={`${pageTheme.card} border-b sticky top-0 z-10`}
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <motion.button
                ...
                className={`p-2 ${themeClasses.text.secondary} hover:${themeClasses.text.primary} transition-colors rounded-lg ${themeClasses.bg.secondary}`}
              >
                <ArrowLeft className="w-5 h-5" />
              </motion.button>
              <div className="flex items-center space-x-3">
                <div 
                    className={`p-2 rounded-xl shadow-lg ${pageTheme.button} text-white`}
                >
                    <Brain className="w-5 h-5" />
                </div>
                <div>
                  <h1 className={`text-lg font-bold ${themeClasses.text.primary}`}>Sensa Memory Integration</h1>
                  <p className={`text-xs ${themeClasses.text.secondary}`}>Share memories to unlock personalized learning</p>
                </div>
              </div>
            </div>
            ...
            <motion.button
              ...
              className={`flex items-center space-x-2 ${pageTheme.accent} hover:opacity-80 font-medium text-sm transition-colors`}
              whileHover={{ x: 2 }}
            >
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          ...
          >
            <div 
              className={`p-4 rounded-full shadow-2xl ${pageTheme.button} text-white`}
            >
              <Brain className="w-10 h-10" />
            </div>
          </motion.div>
          <h2 className={`text-3xl font-light ${themeClasses.text.primary} mb-4`}>
            Your memories are the key to
            <br />
            <span 
              className={`font-medium ${pageTheme.accent}`}
            >
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 w-full h-full backface-hidden">
                  <div className={`w-full h-full ${pageTheme.card} rounded-2xl shadow-xl border ${themeClasses.border.light} overflow-hidden group hover:shadow-2xl transition-all duration-300`}>
                    {/* Card Header */}
                    <div 
                    ...
                    <div className="p-6 flex flex-col justify-between h-48">
                      <div>
                        <p className={`${themeClasses.text.primary} text-sm leading-relaxed mb-4`}>
                          {prompt.prompt}
                        </p>
                      </div>
                      
                      <div className={`bg-gradient-to-r ${prompt.bgGradient} rounded-lg p-3 border ${themeClasses.border.light}`}>
                        <div className="flex items-start space-x-2">
                          <Lightbulb className="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" />
                          <p className={`text-xs ${themeClasses.text.primary}`}>
                ...
                <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180">
                  <div className={`w-full h-full ${pageTheme.card} rounded-2xl shadow-xl border ${themeClasses.border.light} overflow-hidden`}>
                    {/* Back Header */}
                    <div 
                    ...
                    <div className="p-4 h-60 flex flex-col">
                      <textarea
                        ...
                        className={`flex-1 w-full p-3 border ${themeClasses.border.light} rounded-lg focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 outline-none resize-none text-sm ${themeClasses.text.primary} placeholder-gray-400 ${pageTheme.card}`}
                      />
                      
                      <div className="mt-3 flex items-center justify-between">
                        <div className={`flex items-center space-x-2 text-xs ${themeClasses.text.tertiary}`}>
        ...
        >
          <motion.button
            ...
            className={`${pageTheme.button} text-white px-8 py-4 rounded-2xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-3 mx-auto`}
