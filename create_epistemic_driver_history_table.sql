-- SQL script to create the epistemic_driver_history table
...
CREATE INDEX IF NOT EXISTS idx_epistemic_driver_history_user_id ON epistemic_driver_history(user_id);
CREATE INDEX IF NOT EXISTS idx_epistemic_driver_history_created_at ON epistemic_driver_history(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_epistemic_driver_history_is_favorite ON epistemic_driver_history(is_favorite) WHERE is_favorite = true;
CREATE INDEX IF NOT EXISTS idx_epistemic_driver_history_tags ON epistemic_driver_history USING GIN(tags);
