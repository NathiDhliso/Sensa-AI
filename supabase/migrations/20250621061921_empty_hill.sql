/*
  ...
  1. New Tables
    - `users`
      ...
      - `learning_profile` (jsonb, nullable)
    ...
    - `course_analyses`
      ...
      - `analysis_data` (jsonb)
      - `memory_connections` (jsonb, nullable)
      - `career_pathways` (jsonb, nullable)
      - `study_map` (jsonb, nullable)
      - `created_at` (timestamp)
      - `updated_at` (timestamp)
